...
public class CreateAccountControl implements ActionListener
{
  ...
  public CreateAccountControl(JPanel container, GuWeeOhClient client)
  {
  ...
  {
    CreateAccountPanel createAccountPanel = (CreateAccountPanel)container.getComponent(2);
    GuWeeOhClientGUI clientGUI = (GuWeeOhClientGUI)SwingUtilities.getWindowAncestor(createAccountPanel);
